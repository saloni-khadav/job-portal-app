                ...
                <div className="flex gap-2 mb-6 mt-3">
                    {
                        isEdit
                            ...
                            <label className="flex items-center" htmlFor="resumeUpload">
                             ...
                             <input id='resumeUpload' onChange={e=>setResume(e=>setResume(e.target.files[0]))} accept="application/pdf" type="file" hidden/>
                        ...
                        {jobsApplied.map((job,index)=>true ?(
                            <tr>
                              ...
                              <td className="py-2 px-4 border-b">
                                <span className={`${job.status==='Accepted'? 'bg-green-100':job.status==='Rejected'? 'bg-red-100':'bg-blue-100'} px-4 p-1.5 rounded`}>
                                    {job.status}
                                </span>
                              </td>
                            </tr>
